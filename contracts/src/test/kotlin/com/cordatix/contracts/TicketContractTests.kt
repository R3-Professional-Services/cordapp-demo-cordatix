...
class TicketContractTests {
    private val ledgerServices: MockServices = MockServices(listOf("com.cordatix"))
    var alice = TestIdentity(CordaX500Name("Alice", "TestLand", "US"))
    var bob = TestIdentity(CordaX500Name("Bob", "TestLand", "US"))

//    @Test
//    fun dummytest() {
//        val state = TicketState("Hello-World", alice.party, bob.party)
